...
describe("Positions", () => {
  ...
  test("Adding and removing entities", async () => {
    ...
    const param1 = await api.bodyParams._create(bodyParamData1);
  ...
  test("Expand item", async () => {
    ...
    const position1 = await api.positions._create(positionData1);
  ...
  test("Expand list", async () => {
    ...
    const positionsList = await api.positions._readMany();
